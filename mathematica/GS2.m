...
expect[nand[tconst[tconst[fconst[fconst[because[
        nimplies[id[q],f],s],not[r]]]]],
            neqv[nor[tconst[or[fst[t,s],or[f,p]],id[p]],
                     implies[tconst[id[t],tconst[tconst[t]]],
                             nsnd[fconst[fconst[tconst[q]]],
                                  fconst[snd[nbecause[
                                          fst[p,nfst[id[p],nand[t,not[f]]]],t],
                                             fconst[q]]]]]],t]],
       randomBooleanExpression[]]

(* expect[fconst[fconst[s, tconst[t]]], randomBooleanExpression[]] *)

expect[or[tconst[r,q],tconst[tconst[id[eqv[t,not[fconst[t]]]],p]]],
       randomBooleanExpression[]]

(* expect[p, randomBooleanExpression[]] *)

expect[fst[fconst[snd[and[tconst[neqv[s,tconst[id[t]]],nfst[q,nand[not[q],f]]],
                          nfst[snd[because[p,r],q],not[r]]],
                      fconst[tconst[r]]]],tconst[s]],
       randomBooleanExpression[]]

(* expect[p, randomBooleanExpression[]] *)

expect[nsnd[fconst[s],q],
       randomBooleanExpression[]]
