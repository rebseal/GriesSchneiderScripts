...
ClearAll[associativity]
ClearAll[leftAssociativity]
ClearAll[rightAssociativity]
...
ClearAll[contradictionByNot]
ClearAll[invContradictionByNot]
...
ClearAll[leftAssociativityOfDisjunction]
ClearAll[rightAssociativityOfDisjunction]
...
ClearAll[excludedMiddle]
ClearAll[invExcludedMiddle]
...
expect[true
 ,
  Module[{proposition = eqv[or[p, false], p]},
    ...
    // expectBy[    or[p, eqv[false, p]]     , "3.27, distributivity of or"] //
...
ClearAll[identityOfDisjunction]
ClearAll[invIdentityOfDisjunction]
...
Module[{proposition = or[p, or[q, r]]},
       ...
       // expectBy[   or[p, or[r, or[p, q]]], "3.24 symmetry of or /@ 1"] //
       fireRule[rightAssociativityOfDisjunction  , 0]
       // expectBy[   or[or[p, r], or[p, q]], "3.25 associativity /@ 0"] //
       fireRule[symmetryOfDisjunction            , 0]
       // expectBy[   or[or[p, q], or[p, r]], "3.24 symmetry of or /@ 0"] //
       Identity
] ]

ClearAll[distributivityOfOrOverOr]
ClearAll[invDistributivityOfOverOr]
...
Module[{proposition = eqv[or[p, q], or[p, not[q]]]},
       ...
       // expectBy[   p,                     "3.30 identity of or /@ 0"] //
       Identity
] ]
...
ClearAll[goldenRule1]
ClearAll[invGoldenRule1]
...
Module[{proposition = and[p, q]},
       ...
       fireRule[symmetryOfDisjunction, 0]
       // expectBy[eqv[p, q, or[q, p]], "3.24 symmetry of or"] //
...
{left = Module[{proposition = and[and[p, q], r]},
       ...
       // expectBy[
           ...
           "3.27 distributivity of or over eqv"] //
...
right = Module[{proposition = and[p, and[q, r]]},
       ...
       // expectBy[
           ...
           "3.27 distributivity of or and implicit associativity"] //
       fireRuleOnPart[multiplyingOutDisjunction, 5]
       // expectBy[
           eqv[p, q, r, or[p, q], or[p, q, r], or[p, r], or[q, r]],
           "3.27 distributivity of or and implicit associativity"] //
...
Module[{proposition = and[p, p]},
       ...
       // expectBy[p, "3.26 idempotency of or"] //
       Identity
] ]
